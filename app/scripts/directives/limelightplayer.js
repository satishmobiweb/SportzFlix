  ...
  .directive('limelightplayer', function ($timeout, $q) {
        ...
        return {
            ...
            link: function (scope, elem, attrs) {
                    ...
                    console.log('inside init media', scope.media)
                    var player ='<object type="application/x-shockwave-flash" id="limelight_player_406354" name="limelight_player_406354"  class="LimelightEmbeddedPlayerFlash" width="100%" height="600px" data="http://assets.delvenetworks.com/player/loader.swf"> <param name="movie" value="http://assets.delvenetworks.com/player/loader.swf"/> <param name="wmode" value="window"/> <param name="allowScriptAccess" value="always"/>'
